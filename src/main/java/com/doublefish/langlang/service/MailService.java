...
public class MailService {
    ...
    public MailService(Random random, UserMapper userMapper, ResetMailCodeMapper resetMailCodeMapper) {
        this.random = random;
    ...
    public void sendResetEmail(String email){
        ...
        sendSimpleMail(email, "云上琅琅重置密码", "亲爱的用户:" +
                "\n\n"+
                "欢迎使用云上琅琅邮箱重置密码功能。请复制以下验证码填入网页"+"\n\n"
                +code+   "\n\n" +
                "请在5分钟内完成密码修改"+"\n\n"
                +"（本邮件由系统自动发出，请勿回复。）"+"\n"
                +df.format(t)
